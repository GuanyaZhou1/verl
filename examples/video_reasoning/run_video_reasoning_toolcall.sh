#!/bin/bash
# Video Reasoning - 方案二：复用 Tool Call 机制
#
# 使用 veRL 内置的 ToolAgentLoop + FetchFramesTool
# 模型通过 function calling 格式调用 fetch_frames 工具获取视频帧
...
TOOL_CONFIG_PATH="$CONFIG_PATH/tool_config.yaml"
...
EXPERIMENT_NAME="video_reasoning_toolcall_${TIMESTAMP}"
...
echo "USE_CACHED_INITIAL_VIDEO: $USE_CACHED_INITIAL_VIDEO"
echo "AGENT_LOOP: tool_agent"
echo "========================="
...
# ===== STEP 2: Run training =====
echo "===== Step 2: Starting training with ToolAgentLoop ====="
...
nohup python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='video-reasoning-toolcall' \
    ...
    reward_model.custom_reward_function.path=verl.utils.reward_score.video_reasoning \
