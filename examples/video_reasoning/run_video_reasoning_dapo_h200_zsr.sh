...
# Checkpoint 配置
# =============================================================================
CHECKPOINT_DIR="./checkpoints_zsr"   # checkpoint 保存目录
SAVE_FREQ=30
TEST_FREQ=20
...
EXPERIMENT_NAME="Qwen3-VL-8B-Instruct-longvt_tvg-openo3video_stgr-selfconstructdata-sft-lr1e-5-bs64-ep1_dapo_longvt_selfqa_data_watermark_1_genbs32_ep1_lr1e_6_bbox0_6_normadvbystdfalse_${TIMESTAMP}"
...
# =============================================================================
CKPT_BASE="${CHECKPOINT_DIR}/${PROJECT_NAME}/${EXPERIMENT_NAME}"
