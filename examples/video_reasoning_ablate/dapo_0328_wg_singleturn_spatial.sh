...
if [ -z "$EXPERIMENT_NAME" ]; then
    # 自动生成实验名：包含关键超参数
    EXPERIMENT_NAME="Qwen3_8B_singleturn_spatial_${ADV_ESTIMATOR}_acc${REWARD_WEIGHT_ANSWER}_fmt${REWARD_WEIGHT_FORMAT}_bbox${REWARD_WEIGHT_BBOX}_seg${REWARD_WEIGHT_SEGMENT}_kl${KL_LOSS_COEF}_lr${LEARNING_RATE}_$(date +%m%d)_bs${TRAIN_BATCH_SIZE}_test"
fi
# 示例手动设置：
